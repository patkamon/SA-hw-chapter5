...
function setupHandlers(app, db, messageChannel) {
    ...
    function consumeViewedMessage(msg) { // Handler for coming messages.
        ...
        // checking what video path if watching video 1 then recommened video 2 else recommend video 1
        if (parsedMsg.videoPath == "viewed-1") console.log("recommendation video 2") 
        if (parsedMsg.videoPath == "viewed-2") console.log("recommendation video 1")
        ...
        console.log("Recommended Acknowledging message was handled.");
